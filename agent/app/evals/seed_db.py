...
from server.app.db.session import get_sessionmaker
from server.app.db.seed_structured_metrics import seed_structured_metrics, seed_platform_titles_and_viewership
...
if __name__ == "__main__":
    ...
    if "DATABASE_URL" not in os.environ:
        os.environ["DATABASE_URL"] = "postgresql+asyncpg://postgres:postgres@localhost:5433/app_scaffold_test"
